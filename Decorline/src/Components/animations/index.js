...
export const preLoaderAnim = () => {
    ...
    // Animation to remove words one by one
    .to(".texts-container span", {
        ...
        ease: "Power3.easeOut",
        onComplete: () => {
            // This function is executed when all words are shown, you can add logic here if needed
        },
    })
    // Other animations continue...
    .to(".landing", {
        duration: 0.05,
    ...
    .to(
        ".preloader",
        {
            ...
            height: "0vh",
            ease: "Power3.easeOut",
            onComplete: mobileLanding, // Make sure this is just the function reference without "()"
        },
        "-=2"
    )
