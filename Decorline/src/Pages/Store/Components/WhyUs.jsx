...
const WhyUs = () => {
  return (
    <div className='my-8 md:my-4'>
      ...
      <div className='flex justify-center'>  <h1 className='bg-[#FFDA18] h-[97px] w-[593px] lg:h-[80px] lg:w-[500px] md:w-[400px] md:h-[60px] sm:w-[200px] sm:h-[50px] font-bold text-[48px] md:text-[30px] sm:text-[17px] font-Roboto flex justify-center items-center'>Why Decospace</h1>
      </div>
